...
\maketitle
		...
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\begin{figure}
			  		...
			  		\caption{\tiny{\fullcite{Karrer2011}}} \label{fig:}
			  	\end{figure}
			\end{column}
			\begin{column}{0.5\textwidth}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{frame}\frametitle{Empirical Behavior of Q}
		  	\begin{figure}
		  		\centering
		  		\includegraphics[width=\textwidth]{bare_points}
		  	\end{figure}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{frame}\frametitle{Phase Transition}
		  	\begin{figure}
		  		\centering
		  		\includegraphics[width=.5\textwidth]{transition_joy_random}
		  	\end{figure}
		  	\begin{itemize}
		...
		\begin{frame}\frametitle{Supercritical Behavior}
			\begin{columns}
				...
				\begin{column}{0.4\textwidth}
					\begin{figure}
						\centering
						\includegraphics[width=.75\textwidth]{V_term_empirical_sub.pdf}
						\caption{} \label{fig:}
					\end{figure}
				\end{column}
			\end{columns}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{frame}\frametitle{Supercritical Behavior}
		  	\begin{figure}
		  		\centering
		  		\includegraphics[width=.7\textwidth]{full_approx_lambda_0_Q.pdf}
...
\section{Additional Material}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{frame}\frametitle{Pair Approximation}
			...
			\begin{figure}
				\centering
				\includegraphics[width=.7\textwidth]{PA.pdf}
				\caption{} \label{fig:}
			\end{figure}
